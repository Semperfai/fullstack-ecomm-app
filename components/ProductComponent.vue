<template>
  <div
    ...
    class="bg-white inline-block rounded hover:shadow-[0_0_13px_3px_rgba(0,0,0,0,15)] cursor-pointer">
    <NuxtLink :to="`/item/${product.id}`">
      ...
      <div id="ProductDetails">
        ...
        <span
          class="px-1 relative -top-1.5 text-[#FF6674] text-xs font-semibol">
          Extra 5% off
        </span>
        ...
        <div class="flex items-center gap-1 px-1 relative -top-1">
          ...
          <span
            class="bg-[#F5F5F5] text-[#C08562] text-[9px] font-semibold px-1.5 rounded-sm">
            Top Selling
          </span>
        </div>
        ...
        <p class="px-1 pb-1">
          <span class="text-xs text-[#299129] font-semibold"
            >Free Shipping</span
          >
        </p>
      </div>
